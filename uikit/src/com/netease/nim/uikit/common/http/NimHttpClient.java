...
public class NimHttpClient {
    ...
    public void execute(String url, String body, NimHttpCallback callback){
        Map<String, String> headers = new HashMap<>(1);
        headers.put(HEADER_CONTENT_TYPE, "application/x-www-form-urlencoded; charset=utf-8");
        execute(url, headers, body, callback);
    }
     ...
     * @return
     */
    public String postDataToServer(String url, Map<String, String> headers, Map<String, Object> body){
        if(headers == null){
            headers = new HashMap<>(1);
            headers.put(HEADER_CONTENT_TYPE, "application/x-www-form-urlencoded; charset=utf-8");
        }
        HttpClientWrapper.HttpResult<String> result = HttpClientWrapper.post(url, headers, getJsonBody(body));
        return result.obj;
    }

    private String getJsonBody(Map<String, Object> body) {
